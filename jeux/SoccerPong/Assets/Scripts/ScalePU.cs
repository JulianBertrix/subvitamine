...
public class ScalePU : PowerUp
{
    ...
    void OnTriggerEnter2D(Collider2D trig)
    {
        ...
        if (trig.gameObject.tag == "Player")
        {
            ...
            Paddle.scaleUpPlayer1 = true;

            // When the player play an online match
            if (Paddle.online)
            {
                // Change the player 1 scale
                NetworkPlayerController.scaleUpPlayer1 = true;
            }
        ...
        if (trig.gameObject.tag == "Other")
        {
            ...
            Paddle.scaleUpOther = true;

            // When the player play an online match
            if (Paddle.online)
            {
                // Change the player 2 scale
                NetworkPlayerController.scaleUpPlayer2 = true;
            }
